G.entity.Hero = Class.create(G.entity.Entity, {
    initialize: function($super,options) {
        $super();
        G.log("hero entity",this);

        this.SceneObject = new THREE.Object3D();

        // options represents the defaultAttributes object for the model
        this.Model = new G.model['Hero'](options);
        this.buildScene();
    },
    ...
    buildScene: function(){
        ...
        this.SceneObject.position.set(0,10,0);
